...
<h3>Welcome to the Bulgarian Boxer club Website repository! My first application based on the microservices architecture built using Spring Boot and ReactJS for the</h3>
...
<img src="/github_images/ownership.png" style="width: 700px"/>
